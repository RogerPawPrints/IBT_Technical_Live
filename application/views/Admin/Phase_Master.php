...
<script>
    ...
    function Delete_Phase_Master(id)
    {
        ...
        {
            $.ajax({   url:"<?php echo site_url('Admin_Controller/Delete_Phase_Master'); ?>",
                data: {id: id},
                type: "POST",
                cache: false,
                success:function(data){
                    ...
                    {
                        alert("This Phase is Assigned to a Project. Dont Delete the Phase");
                    }
