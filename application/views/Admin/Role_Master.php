                        ...
                        <div class="row">
                            <div class="col-md-12 ">
                                <div class="box-content">
                                    <form method="post" role="form" action="<?php echo site_url('Admin_Controller/insert_Role_Master'); ?>" name="data_register">
                                        <div class="form-group">
                                            <label>Role Master Name</label>
                                            <input type="text" class="form-control" name="Role_master_name" placeholder="Role_master_name" required >
                                        </div>
